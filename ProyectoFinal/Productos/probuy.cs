...
{
    public partial class probuy : DevExpress.XtraEditors.XtraForm
    {
        string nombre;
        public probuy(String nombre)
        {
            InitializeComponent();
            this.nombre = nombre;

            var select = "SELECT nombreTienda as Tienda, nombreProducto as Producto, cantidadProducto as Cant, fechacreación as FechaCr, fecharecogida as FechaRec FROM Reservas WHERE nombreUsuario="+ "'" + nombre +"'" +"AND confirmacion = 2 ";
