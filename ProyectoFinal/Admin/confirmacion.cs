...
{
    public partial class confirmacion : DevExpress.XtraEditors.XtraForm
    {
        Helper.wrapperProduct product;
        all2 pro;
        public confirmacion(Helper.wrapperProduct product, all2 pro)
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Helper helperclass = new Helper();
                ...
                using (SqlConnection conection = new SqlConnection(helperclass.getConnectionDB(@"(localdb)\BrunsdDB1", "BrunsdDB1")))
                {
                    ...
                    string queryUpdate = "UPDATE Reservas SET confirmacion = " + 2 + "WHERE idReserva=@idProd";
